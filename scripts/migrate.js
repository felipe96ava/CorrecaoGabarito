...
// Split bem simples: remove blocos de comentário `--` linha-a-linha e
// quebra em `;` no fim de uma linha. Não cobre $$...$$ blocks (não usamos).
...
async function main() {
  ...
  for (const filename of files) {
    ...
    // Neon serverless usa prepared statements, que não aceitam múltiplos
    // comandos numa única chamada. Dividimos o arquivo em statements
    // separados (delimitador: `;` no fim de uma linha) e rodamos um a um.
